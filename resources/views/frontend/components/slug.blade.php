<div class="container">
    ...
    <div class="row mb-3">
        <div class="col-12 mobile-open-fileter-container">
            <h5 class="text-muted">
                Showing {{ $products->total() }} {{ Str::plural('product', $products->total()) }}
            </h5>
            <!-- <h5 class="mobile-filter-btn"><i class="fa-solid fa-filter"></i> Filter</h5> -->
            <h5 class="mobile-filter-btn" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
