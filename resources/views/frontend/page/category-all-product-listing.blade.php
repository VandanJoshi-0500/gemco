...
<section class="product_listing product_listing_outer_div">
    ...
    <div class="container-fluid p-0 product_listing_innerbanner test" style="background-image: url('{{ URL::asset('public/assets/images/shop/shop-banner03.jpg') }}'); background-size: cover; background-position: center;">
            ...
            <div class="product_listing_left">
                ...
                <form id="filterForm">
                    ...
                    <div class="">
                        ...
                        <h5 class=""> Sort By Collections</h5>
                        ...
                        <div class="my-3">
                            ...
                            @foreach($pro_collections as $pro_coll)
                                ...
                                <div class="collection-checkbox">
                                    ...
                                    <input type="checkbox" id="coll-{{ $pro_coll->id }}" name="coll[]" class="chk" value="{{ $pro_coll->id }}">

                                    <label for="coll-{{ $pro_coll->id }}">{{ $pro_coll->name }}</label>
