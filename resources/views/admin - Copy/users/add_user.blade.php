        ...
        <div class="card-body">
            <form action="{{route('admin.add.user.data')}}" method="post" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" class="form-control" name="website" id="Website" value="{{old('website')}}" placeholder="" />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="company" id="Company" value="{{old('company')}}" placeholder="" />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="streetaddress" id="StreetAddress" value="{{old('streetaddress')}}" placeholder="" />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="city" id="City" value="{{old('city')}}" placeholder="" />
                    @if ($errors->has('city'))
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="zipcode" id="ZipCode" value="{{old('zipcode')}}" placeholder="" />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="fax" id="Fax" value="{{old('fax')}}" placeholder="" />
                    @if ($errors->has('fax'))
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="discount_percentage" id="DiscountPercentage" value="@if(old('discount_percentage')){{old('discount_percentage')}}@else 0 @endif" placeholder="" />
