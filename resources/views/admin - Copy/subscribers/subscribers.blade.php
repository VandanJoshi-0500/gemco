    ...
    <div class="card-body card-head">
        <div class="d-md-flex gap-4 align-items-center">
            ...
            <div class="ms-auto d-flex arcon-user-inner-search-outer">
                <a href="{{ route('admin.add.subscriber') }}" class="ms-2 btn gc_btn">
                ...
                @if (count($subscribers) > 0)
                    @foreach ($subscribers as $subscriber)
                        <tr>
                            ...
                            <td data-header="Email Address"><a href="{{ route('admin.edit_subscriber',$subscriber->id) }}" class="text-primary">{{$subscriber->email}}</a></td>
                            <td data-th="Status">
                            ...
                            <td data-th="Action" class="text-md-end">
                                <div class="d-flex float-end">
                                    <a href="{{ route('admin.edit_subscriber',$subscriber->id) }}" class=""><i class="ri-edit-2-fill fs-20"></i></a>
        ...
        $(document).on('click','.delete-btn',function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "{{route('delete.subscriber', '')}}"+"/"+user_id,
                        type : 'GET',
                        dataType:'json',
