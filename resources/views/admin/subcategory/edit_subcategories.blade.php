...
<div class="gc_row">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.update.subcategory', $subcategory->id)}}" method="post" enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="slug" id="Slug" value="{{$subcategory->slug}}" placeholder="">
                    @if ($errors->has('slug'))
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="meta_text" id="meta_text" class="form-control" value="{{ $subcategory->meta_text }}">
                </div>
                <div class="col-md-6">
                    <label for="meta_description" class="form-label">Meta Description</label>
                    <input type="text" name="meta_description" id="meta_description" class="form-control" value="{{ $subcategory->meta_description }}">
                </div>
                <div class="col-md-12">
                    <label for="keywords" class="form-label">Keywords</label>
                    <input type="text" name="keywords" id="keywords" class="form-control" value="{{ $subcategory->keywords }}">
                </div>

                <div class="col-md-6">
                    <label for="Status" class="">Status <span class="text-danger">*</span></label>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="status" id="flexSwitchCheckChecked" @if($subcategory->status == 1) checked @endif />
