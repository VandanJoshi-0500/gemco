    ...
    <div class="card">
        <div class="card-body">
            @if (Session::has('alert'))
                <p class="alert
            {{ Session::get('alert-class', 'alert-danger') }}">{{ Session::get('alert') }}
                </p>
            @endif
            <form action="{{ route('admin.edit.category') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    ...
                    <select name="parent" id="Parent" class="form-control">
                        ...
                        @foreach ($categories as $item)
                            <option value="{{ $item->id }}" @if ($category->parent == $item->id) selected @endif>
                                {{ $item->name }}</option>
                        @endforeach
                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <img id="uploaded-image-preview"
                                    src="{{ url('/') }}/public/categories/{{ $category->image }}" width="80px"
                                    alt="">
                ...
                <div class="col-md-12 imagelink @if ($category->image_type != 2) d-none @endif">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="image_link" id="ImageLink"
                            value="{{ $category->image }}" placeholder="" />
                        @if ($errors->has('image'))
                            <span class="text-danger">{{ $errors->first('image') }}</span>
                        @endif
                    </div>
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-3">
                            <img id="uploaded-menu-image-preview"
                                src="{{ url('/') }}/public/categories/{{ $category->menu_image }}" width="80px"
                                alt="">
                            <input type="hidden" name="hidden_menu_image" class="hidden_menu_image"
                                value="{{ $category->menu_image }}">
                        </div>
                        <div class="col-md-9">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="meta_text" id="MetaText"
                        value="{{ $category->meta_text }}" placeholder="" />
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="meta_description" id="MetaDescription"
                        value="{{ $category->meta_description }}" placeholder="" />
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="keyword" id="Keyword"
                        value="{{ $category->keyword }}" placeholder="" />
                ...
                <div class="col-md-12">
                    <label for="showDropdownSwitch" class="form-label">Show in Dropdown <span class="text-danger">*</span></label>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="showindropdown" id="flexSwitchCheckChecked"
                            @if ($category->showindropdown == 1) checked @endif>
                        <label class="form-check-label" for="flexSwitchCheckChecked"></label>
                    </div>
                </div>
                {{-- <div class="col-md-12">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="showindropdown" id="showDropdownSwitch"
                            @if ($categories->showindropdown == 1) checked @endif />
