                    ...
                    <form action="{{ route('admin.add_category_data') }}" method="POST" class="row g-3"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="meta_text" id="MetaText"
                                value="{{ old('meta_text') }}" placeholder="" />
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="meta_description" id="MetaDescription"
                                value="{{ old('meta_description') }}" placeholder="" />
                        ...
                        <div class="col-md-12">
                            <label for="showDropdownSwitch" class="">Show in Dropdown <span class="text-danger">*</span></label>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="showindropdown"
                                    id="showDropdownSwitch" checked />
                                        ...
                                        <td class="text-end align-middle">
                                            <div class="d-flex float-end">
                                                <a href="{{ route('admin.edit_category', $category->id) }}"
                                                    class=""><i class="ri-edit-2-fill fs-20"></i></a>
                                                <a href="javascript:void(0);" data-id="{{ $category->id }}"
                                                    class="ms-2 delete-btn"><i class="ri-delete-bin-fill fs-20"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @foreach ($categories as $item)
                                        @if ($category->id == $item->parent)
                                            <tr>
                                                <td class="align-middle"><a
                                                        href="{{ route('admin.edit_category', $item->id) }}"
                                                        class="text-primary"><span class="ps-3">-
                                                            {{ $item->name }}</span></a></td>
                                                {{-- <td class="align-middle">
                                            @if (!blank($item->image))
                                                    ...
                                                    <div class="d-flex float-end">
                                                        ...
                                                        <a href="javascript:void(0);" data-id="{{ $item->id }}"
                                                            class="ms-2 delete-btn"><i
                                                                class="ri-delete-bin-fill fs-20"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endif
