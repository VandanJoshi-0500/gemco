        ...
        <form action="" method="POST" class="row g-3" enctype="multipart/form-data">
           @csrf
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="companyName" name="company_name" placeholder=" " value="">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="PostalCode" name="postal_code" value="">
